...
- `undo_manager.py` represents editor snapshots, filename-clue provenance, session patches, managed snapshots, saved transactions, and history limits separately from Qt application.
